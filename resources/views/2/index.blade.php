...
<body>
            ...
            <div class="row">
                <div class="col-12">
                    <h1 class="text-center grabber">
                        ...
                        Women who used Johnson & Johnson Baby Powder or Shower to Shower Powder, may be owed a large sum
                        of money..
                    </h1>
                </div>
                <div class="col-lg-10 offset-lg-1 col-sm-12 offset-sm-0 stagecard" id="formTop">
                    <div class="col-8 offset-2 text-center">
                        ...
                        <div class="progress" style="height: 30px;">
                            <div class="progress-bar progress-bar-striped bg-success" role="progressbar"
                                style="width: 25%;background-color:#e787ed;" aria-valuenow="25" aria-valuemin="0"
                    ...
                    <form class="claim-form" method="POST" action="{{ url()->current() }}">
                        ...
                        <div class="col-10 offset-1 form-slide slide-one" style="display: block;">
                            ...
                            <div class="row questions">
                                <div class="col-12 text-center questionbtn">
                                    <!-- <a href="qualify.php"> -->
                                    <button type="button" class="btn custombtn yes" data-value="Ovarian Cancer">
                                ...
                                <div class="col-12 text-center questionbtn">
                                    <!-- <a href="qualify.php"> -->
                                    <button type="button" class="btn custombtn no" data-value="Fallopian Tube Cancer">
                                ...
                                <div class="col-12 text-center questionbtn">
                                    <!-- <a href="qualify.php"> -->
                                    <button type="button" class="btn custombtn no" data-value="Mesothelioma">
                                        <img id="no" src="img/checkup.png" width="26" height="23" alt="" />
                                ...
                                <div class="col-12 text-center questionbtn">
                                    <!-- <a href="qualify.php"> -->
                                    <button type="button" class="btn custombtn no" data-value="Peritoneal Cancer">
                                        <img id="no" src="img/checkup.png" width="26" height="23" alt="" />
                                ...
                                <div class="col-12 text-center questionbtn">
                                    ...
                                    <button type="button" class="btn custombtn no"
                                        data-value="death from Ovarian or Fallopian Tube Cancer">
                                        <img id="no" src="img/checkup.png" width="26" height="23" alt="" />
                                ...
                                <div class="col-12 text-center questionbtn">
                                    <!-- <a href="qualify.php"> -->
                                    <button type="button" class="btn custombtn no" data-value="No / Others">
                                        <img id="no" src="img/checkup.png" width="26" height="23" alt="" />
                                        <span>No / Others</span>
                                    </button>
                                    <!-- </a> -->
                            ...
                            <div class="row questions">
                                <div class="col-lg-6 col-sm-12 text-center questionbtn">
                                    ...
                                    <button type="button" class="btn custombtn yes">
                                        <img id="yes" src="img/checkup.png" width="26" height="23" alt="" /> <span>2008
                                            to 2022</span>
                                    </button>
                                    <!-- </a> -->
                                </div>
                                <div class="col-lg-6 col-sm-12 text-center questionbtn">
                                    <!-- <a href="qualify2.php"> -->
                                    <button type="button" class="btn custombtn no">
                                        <img id="no" src="img/checkup.png" width="26" height="23" alt="" /> <span>2007
                                            or before</span>
                                    </button>
                                    <!-- </a> -->
                                </div>
                        ...
                        <div class="col-10 offset-1 form-slide slide-four">
                            <h1 class="text-center bigquestion2 fadeIn">Do you already have a lawyer representing this
                                claim?</h1>
                            <div class="row questions">
                                <div class="col-6  text-center questionbtn">
                                    <!-- <a href="info.php"> -->
                                    <button type="button" class="btn custombtn yes"><img id="yes" src="img/checkup.png"
                                            width="26" height="23" alt="" /> <span>Yes</span></button>
                                    <!-- </a> -->
                                </div>
                                <div class="col-6  text-center questionbtn">
                                    <!-- <a href="info.php"> -->
                                    <button type="button" class="btn custombtn no"><img id="no" src="img/checkup.png"
                                            width="26" height="23" alt="" /> <span>No</span></button>
                                    <!-- </a> -->
                                </div>
                                <div class="">
                                    <br>
                            ...
                            <div id="slide4" class="">
                                <div class="form-row">
                                    <div class="form-group col-12" style="width:100%">
                                        <input type="text" class="big form-control" name="first_name" id="first_name"
                                            placeholder="First Name" required="">
                                    </div>
                                    <div class="form-group col-12" style="width:100%">
                                        <input type="text" class="big form-control" name="last_name" id="last_name"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-12" style="width:100%">
                                        <input type="text" class="big zip_code form-control" name="zip_code"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-12" style="width:100%">
                                        <label class="checkbox-inline">
                                            <div class="small">
                                                By submitting this information, you agree to our Terms &amp; Conditions
                                                and that {{$company}}s and its partner law firms may contact you about
                                                their services at your above phone number(s) even if it is on a National
                                                or State Do Not Call List. Calls/texts may employ automated dialing
                                                technology and pre-recorded/artificial voice messages. I understand my
                        ...
                        <div class="col-10 offset-1 form-slide slide-six">
                            ...
                            <h1 class="text-center bigquestion2">We have submitted your information for a Fast, Free
                                Case Review!</h1>
                            <div class="row questions">
                                <div class="">
                                    <br>
    ...
    <section class="container about">
        <div class="row">
            <div class="col-sm-12">
                <h1>
                    Families have relied on talcum powder for decades without realizing the considerable cancer risk it
                    posed.
                </h1>
            </div>
    ...
    <br><br>
    <div class="bottomMenu">Ready for a Fast, Free Case Review? <a href="#formTop"><button class="btn btn-success">Click
                Here</button></a></div>
</body>
